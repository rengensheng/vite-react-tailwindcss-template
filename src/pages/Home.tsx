    ...
    <>
      ...
      <div className="flex flex-col items-center p-4 bg-gray-100 rounded-lg shadow-md max-w-md mx-auto">
        <button
          ...
          className="px-6 py-3 mb-4 text-lg font-semibold text-white bg-blue-600 rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-blue-500 focus:ring-opacity-50 transition-colors duration-300"
        >
          count is {count}
        </button>
